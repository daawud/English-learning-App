...
import HeaderUserPic from '~/components/HeaderUserPic/HeaderUserPic.jsx';
...
class NavbarRight extends Component {
    ...
    render() {
        ...
        const fullBar = (
            <MDBNavbarNav right>
                <MDBNavItem>
                    <span className="user-points" data-toggle="tooltip" title="Количество доступных очков для открытия новых уроков">22</span>
                </MDBNavItem>
                <MDBNavItem>
                    <HeaderUserPic />
                </MDBNavItem>
