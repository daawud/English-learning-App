...
import icon from '~/assets/img/main-page-middle-block-icon.svg';
        ...
        <div className="middle-block">
            <div className="middle-block__content">
                <div className="middle-block__span-1 middle-block__flex">
                    <img className="middle-block__icon" src={icon} alt="иконка"/>
                    <p className="middle-block__text">Удобные карточки изучения новой лексики</p>
                </div>
                <p className="middle-block__span-2 middle-block__text-small">Не просто списки, а примеры употребления слов</p>
                <p className="middle-block__span-3 middle-block__text-small">Напоминания о занятии</p>
                <p className="middle-block__span-4 middle-block__text-small">Эффект Ресторффа (запоминай отличающееся слово в группе)</p>
